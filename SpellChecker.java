...
/*class to find metaphones. This is based on the metaphone rules */
	class Metaphone{
		...
		//method to remove duplicate letters except C(rule 1)
		...
		//method to remove first letter if "kn" etc(rule 3) and to remove b from end if "mb" etc (rule 2)
  ...
  public class SpellChecker extends Metaphone{
    	...
    	static int order[]=new int[200];
	     ...
	     static void setup()
	     {
	        ...
	        try {
	            BufferedReader bufferedReader = new BufferedReader(new FileReader("C:\\Users\\S.C.R.PESHWA\\Desktop\\dictionary.txt"));
	            String line = null; 
